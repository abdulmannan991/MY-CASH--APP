...
class _ScreenTwoState extends State<ScreenTwo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 70, 200, 214),
        ...
        child: Stack(children: [
              ...
              child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20)),
                    primary: Color.fromARGB(255, 70, 200, 214),
                  ),
                  onPressed: () {
          ...
          Container(
              ...
              child: Icon(
                Icons.house,
                size: 60,
                color: Color.fromARGB(255, 70, 200, 214),
              )),
          Container(
          ...
          Padding(
            padding: const EdgeInsets.only(top: 490, left: 430),
            child: Container(
              height: 20,
              width: 60,
              child: ElevatedButton(
